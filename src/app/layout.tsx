...
export const metadata: Metadata = {
  title: "NeonPulse",
  description: "Create a static single-page crypto landing with a futuristic yellow theme to attract and onboard users"
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${interTight.variable} ${playfairDisplay.variable} antialiased`}>{children}
